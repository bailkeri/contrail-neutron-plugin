...
sources = [
    ...
    'neutron_plugin_contrail/plugins/opencontrail/loadbalancer/f5/f5_driver.py',
    'neutron_plugin_contrail/plugins/opencontrail/loadbalancer/f5/db.py',
    'neutron_plugin_contrail/plugins/opencontrail/loadbalancer/f5/__init__.py',
    'neutron_plugin_contrail/plugins/opencontrail/loadbalancer/ha_proxy/driver.py',
    'neutron_plugin_contrail/plugins/opencontrail/loadbalancer/ha_proxy/__init__.py',
